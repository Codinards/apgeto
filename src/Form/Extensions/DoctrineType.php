...
abstract class DoctrineType extends AbstractType implements ResetInterface
{
    ...
    {
        return self::$translatorExtesion->__u((string) $choice);
    }
    ...
    protected static $translatorExtesion;

    public function __construct(ManagerRegistry $registry, TranslatorTwigExtension $translatorExtesion)
    {
        $this->registry = $registry;
        self::$translatorExtesion = $translatorExtesion;
    }
