 ...
 */
class AppFormBuilder extends FormBuilder
{
    /**
    ...
    public function add($child, string $type = null, array $options = [])
    {
        if (isset($options['label_attr'])) {
            if (isset($options['label_attr']['style'])) {
                $options['label_attr']['style'] .= 'font-weight:bold;';
            }
        } else {
            $options['label_attr']['style'] = 'font-weight:bold;';
        }
        $options['label'] = TranslatorTwigExtension::getInstance()
            ->__u($child, [], null, LocalLanguages::getInstance()->getLocaleKey());
