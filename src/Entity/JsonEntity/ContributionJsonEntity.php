...
class ContributionJsonEntity implements JsonEntityInterface
{
    private $filename = 'assistance_contribution.json';
    ...
    public function getData(int $id): array
    {
        ...
        if (isset($data[$id])) {
            return (new Collection($data[$id]))->keyBy(fn ($item) => $item['id']);
        }
        return [];
    }
}
